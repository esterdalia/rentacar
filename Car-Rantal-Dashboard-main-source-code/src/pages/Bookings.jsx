  ...
  return (
    ...
    <div className="bookings">
        ...
        <h2 className="booking__title">Alugue seu Carro</h2>
         ...
         <div className="filter__widget-01">
          ...
          <option value="Selecionar">Selecionar</option>
            <option value="Carro Hatch Compacto">Carro Hatch Compacto</option>
      ...
      <div className="filter__widget-01">
          ...
          <select onChange={(e) => setSearchTerm2(e.target.value)}>
          <option value="Selecionar">Selecionar</option>
      ...
      <div className="booking__car-list">
        ...
        {carData.filter((val) => {
          if ((searchTerm === val.category||searchTerm === "Selecionar") 
          && (searchTerm2 === val.city||searchTerm2 === "Selecionar")) {
            return val;
          }      
